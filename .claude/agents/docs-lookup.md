---
name: docs-lookup
description: "[autoport · portfolio personal-site developer-branding] When the user asks how to use a library, framework, or API or needs up-to-date code examples, use Context7 MCP to fetch current documentation and return answers with examples. Invoke for docs/API/setup questions."

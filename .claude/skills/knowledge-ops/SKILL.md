---
name: knowledge-ops
description: "[autoport · portfolio personal-site developer-branding] Knowledge base management, ingestion, sync, and retrieval across multiple storage layers (local files, MCP memory, vector stores, Git repos). Use when the user wants to save, organize, sync, deduplicate, or search across their knowledge systems."
origin: ECC
---

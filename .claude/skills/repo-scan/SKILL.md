---
name: repo-scan
description: "[autoport · portfolio personal-site developer-branding] Cross-stack source code asset audit — classifies every file, detects embedded third-party libraries, and delivers actionable four-level verdicts per module with interactive HTML reports."
origin: community
---
# repo-scan

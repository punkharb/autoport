---
name: terminal-ops
description: "[autoport · portfolio personal-site developer-branding] Evidence-first repo execution workflow for ECC. Use when the user wants a command run, a repo checked, a CI failure debugged, or a narrow fix pushed with exact proof of what was executed and verified."
origin: ECC
---
# Terminal Ops

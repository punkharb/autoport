---
name: error-handling
description: "[autoport · portfolio personal-site developer-branding] Patterns for robust error handling across TypeScript, Python, and Go. Covers typed errors, error boundaries, retries, circuit breakers, and user-facing error messages."
origin: ECC
---

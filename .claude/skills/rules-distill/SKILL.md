---
name: rules-distill
description: "[autoport · portfolio personal-site developer-branding] Scan skills to extract cross-cutting principles and distill them into rules — append, revise, or create new rule files"
origin: ECC
---
# Rules Distill

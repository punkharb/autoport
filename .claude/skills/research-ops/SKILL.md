---
name: research-ops
description: "[autoport · portfolio personal-site developer-branding] Evidence-first current-state research workflow for ECC. Use when the user wants fresh facts, comparisons, enrichment, or a recommendation built from current public evidence and any supplied local context."
origin: ECC
---
# Research Ops

---
name: skill-scout
description: "[autoport · portfolio personal-site developer-branding] Search existing local, marketplace, GitHub, and web skill sources before creating a new skill. Use when the user wants to create, build, fork, or find a skill for a workflow."
origin: community
---
# Skill Scout

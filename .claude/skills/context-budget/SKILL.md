---
name: context-budget
description: "[autoport · portfolio personal-site developer-branding] Audits Claude Code context window consumption across agents, skills, MCP servers, and rules. Identifies bloat, redundant components, and produces prioritized token-savings recommendations."
origin: ECC
---
# Context Budget
